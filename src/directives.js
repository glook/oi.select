import throttleFn from './helpers/throttle';

export default /* @ngInject */($document, $q, $timeout, $parse, $interpolate, $injector, $filter, $animate, oiUtils, oiSelect) => ({
    restrict: 'AE',
    ...
    compile: (element, attrs) => (scope, element, attrs, ctrl) => {
        ...
        function render() {
            ...
            scope.blur = () => {
                const resetOptions = keepQuery ? {query: true} : {};
